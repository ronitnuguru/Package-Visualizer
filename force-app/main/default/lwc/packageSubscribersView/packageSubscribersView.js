...
export default class PackageSubscribersView extends LightningElement {
  ...
  get tableOptions() {
    return [
      ...
      { label: "Custom Upgrade Type", value: "customUpgradeType" },
      { label: "Restriction Enabled", value: "hasRestrictionEnabled" },
      { label: "Custom Upgrade Allowed", value: "isCustomUpgradeAllowed" },
  ...
  getPackageSubscriberDetails(row) {
    ...
    this.customUpgradeType = row.customUpgradeType;
    this.hasRestrictionEnabled = row.hasRestrictionEnabled;
    this.isCustomUpgradeAllowed = row.isCustomUpgradeAllowed;
