...
export const SETTING_OPTIONS = [
    ...
    { label: 'Agentforce For Developers Settings', value: 'agentforceForDevelopersSettings' },
    ...
    { label: 'Email Authorization Settings', value: 'emailAuthorizationSettings' },
    ...
    { label: 'Iframe White List Url Settings', value: 'iframeWhiteListUrlSettings' },
    ...
    { label: 'Warranty Life Cycle Mgmt Settings', value: 'warrantyLifeCycleMgmtSettings' },
...
export const TEMPLATES = {
    ...
    netZero: {
        ...
        features: ['SustainabilityApp', 'SustainabilityCloud', 'TCRMforSustainability', 'DisclosureFramework'],
        settings: {}
    },
    pubSec: {
        label: 'Public Sector Cloud',
        features: ['PublicSectorAccess', 'PublicSectorApplicationUsageCreditsAddOn', 'PublicSectorSiteTemplate'],
        settings: {}
    }
};
